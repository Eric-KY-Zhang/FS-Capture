...
**起草日期**：2026-05-23
**最后更新**：2026-05-23（v1.0 批次 3 strings.py 双语拆分完成）
...
| **v1.0** | **品牌重命名 Filings Atlas + 中英双语 UI + sidecar 迁移 + JP/UK + 增量 + IPO 统一**（首个 GitHub release） | 4-6 周 | 🟡 **实施中：批次 3 已完成**（11 批次 + 3 Checkpoint） | 7 市场 e2e 全绿 + 双语 UI + `output/` 100% PDF + GitHub release artifact |
