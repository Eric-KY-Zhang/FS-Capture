...
| **v1.0** | 🟡 **实施中：批次 2 i18n 脚手架已完成**（11 批次 + 3 Reviewer Checkpoint，首发 GitHub release）— Filings Atlas / 全球披露图谱 + 双语 UI + sidecar 迁移 + JP/UK + 增量 | `roadmap/SPRINT_v1.0_filings_atlas.md` |
...
**最后更新**：2026-05-23（v1.0 批次 2 i18n 脚手架完成，下一批次为 strings.py 双语拆分）
